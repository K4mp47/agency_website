...
export default function GlobeDemo() {
  const globeConfig = {
    pointSize: 4,
    globeColor: "#000000",              // Nero per il globo
    showAtmosphere: true,
    atmosphereColor: "#000000",         // Bianco per l'atmosfera
    atmosphereAltitude: 0.05,
    emissive: "#ffffff",                // Bianco per riflessi
    emissiveIntensity: 10,
    shininess: 0.5,
    polygonColor: "#1a1a1a",            // Grigio molto scuro per rilievi
    arcTime: 1000,
    arcLength: 0.9,
    rings: 0.2,
    maxRings: 2,
